...
public class CartController {
  ...
  public @ResponseBody String addItem(@ModelAttribute Cart cart, Model model, @RequestParam Integer id, @RequestParam Integer item_id, @RequestParam Integer quantity) {
